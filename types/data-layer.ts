...
export interface DataLayer {
  ...
  subscribeWatchlist(onChange: (items: WatchlistItem[]) => void, onError?: (error: Error) => void): () => void;
  subscribeContinueWatching(onChange: (items: PlaybackProgress[]) => void, onError?: (error: Error) => void): () => void;
