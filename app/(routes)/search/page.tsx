    ...
    <section className="page-shell space-y-6 py-6 md:space-y-8 md:py-10">
      <div className="liquid-glass rounded-[2.3rem] px-6 py-8 md:px-8 md:py-10">
        ...
        <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--muted)]">
          Debounced, cached search across movies and TV with local filter memory and responsive results.
        </p>

        <div className="mt-7 flex flex-col gap-4">
          <div className="liquid-glass-soft flex items-center gap-3 rounded-[1.8rem] px-5 py-4">
